...
public class Driver {
	...
	public static WebDriver webDriver(String browser) {
		...
		switch (browser) {
		case "Chrome":
			System.setProperty("webdriver.chrome.driver", "C:/Automatizacao/chromedriver.exe");
		...
		case "Firefox":
			System.setProperty("webdriver.gecko.driver", "C:/Automatizacao/geckodriver.exe");
		...
		case "Edge":
			System.setProperty("webdriver.edge.driver", "C:/Automatizacao/MicrosoftWebDriver.exe");
	...
	public static void setUrlBase() {
		webDriver.get("http://192.168.236.128/reports/quicker/index.htm");								
